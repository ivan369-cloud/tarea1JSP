...
public class sr_estudiante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            //out.println("<p>"+ request.getParameter("txt_carnet") + "</p>");
            ...
            //out.println("<p>"+ request.getParameter("txt_email") + "</p>");
            //out.println("<p>"+ request.getParameter("txt_fn") + "</p>");
            //out.println("<p>"+ request.getParameter("drop_sangre") + "</p>");
            estudiante = new Estudiante(request.getParameter("txt_carnet"),Integer.valueOf(request.getParameter("drop_sangre")),Integer.valueOf(request.getParameter("txt_id")),request.getParameter ("txt_nombres"),request.getParameter ("txt_apellidos"),request.getParameter ("txt_direccion"),request.getParameter ("txt_telefono"),request.getParameter ("txt_email"),request.getParameter ("txt_fn"));
